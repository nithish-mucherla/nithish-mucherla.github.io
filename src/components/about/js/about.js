      ...
      <Grid container className="content">
        ...
        <Grid container item xs={10} lg={10} justify="space-evenly">
          ...
          <Grid item xs={12} lg={6}>
            ...
            <div className="sub-content">
              <p>
                <br />A Tech enthusiast motivated by the inner self, exploring
                various technologies. A firm believer of
                <a
                ...
                An experienced committee member with a demonstrated history of
                ...
                <br />
                <br />
                Being an active part of a chapter{" "}
                <a
                  href="https://ieeetemsvit.org"
                  className="outboundLink"
                  rel="noopener"
                >
                  <b> (IEEE TEMS)</b>
                ...
                guide my peers in a way that motivates me to work more and
                contribute to the community at the same time. A graduate to be,
                with a Bachelor of Technology focused in Computer Science from{" "}
                <a
